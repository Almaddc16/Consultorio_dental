...
<tr> <!-- esto es una fila-->
 ...
 echo"<tr>";
		...
		echo "<td><a class='btn btn-primary btn-lg' href=formulario2.php?pk_material=".$row['pk_material']." "; ?>onclick="return confirm('¿En verdad desea modificar este registrro?','Confirma')" <?php echo"> Modificar </a></td>";
